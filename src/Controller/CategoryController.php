...
class CategoryController extends AbstractController
{
    ...
    public function new(Request $request, CategoryRepository $categoryRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $uploadedFile = $form['category_icon']->getData();

            if ($uploadedFile) {
                $destination = $this->getParameter('kernel.project_dir') . '/public/uploads/category_image';
                ...
                $category->setCategoryIcon($newFilename);
